...
import { FaArrowLeft, FaArrowRight, FaShoppingBasket, FaStar } from "react-icons/fa";
      ...
      <div className="container mx-auto py-[60px]">
        <div>
          ...
          <div className="w-full py-8">
            ...
            >
              {Books.map((bookbest) => (
                <SwiperSlide key={bookbest.ISBN}>
                  <div className="flex flex-row gap-3">
                    <img
                      className="w-[170px] h-[243px] rounded-lg"
                      src={`data:image/png;base64,${(bookbest.bookImage)}`}
                  alt={bookbest.bookTitle}
                    />
                    <div>
                      <div className="flex items-center gap-2">
                        <button className="text-[12px] font-medium bg-bgbtnHome text-white py-[12px] px-[18px] rounded-lg">
                          {bookbest.description}
                        </button>
                      ...
                      <div className="py-8">
                        <h1 className="text-[24px] font-medium">
                          {bookbest.bookTitle > 20
                            ? bookbest.bookTitle.slice(0, 20) + "..."
                            : bookbest.bookTitle}
                        </h1>
