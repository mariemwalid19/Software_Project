...
const Books = () => {
  const { advancedSearch, gridBtn, setGridBtn, searchBooks, setBookSearch, bookSearch, setBookSearchResult } = useContext(BooksContext);
        ...
        <div className="container mx-auto">
          ...
          <div className="relative">
            <input
              ...
              className="w-full lg:w-[full] text-[20px] lg:text-[20px] ps-2 drop-shadow-2xl font-medium h-[40px] focus:outline-none"
              type="serach"
