...
const AddButtons = () => {
  const role = localStorage.getItem('role'); //  your token is stored in localStorage
  const userid = localStorage.getItem('userid'); //  your token is stored in localStorage
